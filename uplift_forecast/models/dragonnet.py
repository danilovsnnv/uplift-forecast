...
from ..losses import DragonNetLoss


class DragonNet(BaseNeuralUpliftModel):
    ...
    def __init__(
        ...
        **trainer_kwargs,
        ...
        super().__init__(
            ...
            loss=loss if loss is not None else DragonNetLoss(),
        ...
        self.lin_treatment = nn.Linear(hidden_size, 1)
